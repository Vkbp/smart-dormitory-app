...
7. **Documentation Governance Workflow**: Mọi task thực thi phải tuân thủ quy trình: `Task Identification -> Implementation -> Verification -> Documentation Synchronization -> Completion Signature -> GitHub Push`.
8. **Failsafe Protocol**: Agent không được phép báo hoàn thành nếu chưa có bảng "AGENT SYNC VERIFICATION" đồng bộ giữa Code, Docs và GitHub.
