...
sealed class Screen(val route: String, val title: String) {
    ...
    data object RoomUtilities : Screen("room_utilities", "Tiện ích phòng")
    data object Maintenance : Screen("maintenance", "Báo cáo bảo trì")
    data object CreateMaintenance : Screen("create_maintenance", "Gửi yêu cầu bảo trì")
